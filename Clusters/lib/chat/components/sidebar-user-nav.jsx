      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="start" side="top" className="w-56">
            ...
            <DropdownMenuItem asChild>
              <a href="https://github.com/23systems/23wf/issues" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2" style={{ textDecoration: 'inherit', color: 'inherit' }}>
                <BugIcon size={14} />
