...
```bash
# Remove the old skill files (preserve active/ symlinks, list-secrets, modify-self)
rm -rf templates/skills/search-web templates/skills/automate-browser templates/skills/README.md templates/skills/LICENSE
