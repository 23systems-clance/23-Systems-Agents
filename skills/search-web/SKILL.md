---
name: search-web
description: Search the web and extract content via Brave Search API. Use for searching documentation, facts, or any web content. Lightweight, no browser required.
---
...
skills/search-web/search.js "query" --freshness 2024-01-01to2024-06-30  # Date range
skills/search-web/search.js "query" --country DE            # Results from Germany
skills/search-web/search.js "query" -n 3 --content          # Combined options
```
...
```bash
skills/search-web/content.js https://example.com/article
```
