...
echo "1. Run \`skills/compliance/implement.sh $FRAMEWORK\` to generate missing policies and controls"
...
echo "3. Set up continuous monitoring: \`skills/compliance/monitor.sh $FRAMEWORK\`"
fi)
